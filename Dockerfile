...
LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="lod.opentransportdata.swiss" \
      org.label-schema.description="Trifid for Swiss Linked Open Transport Data" \
      org.label-schema.url="https://lod.opentransportdata.swiss" \
      org.label-schema.vcs-url="https://github.com/zazuko/lod.opentransportdata.swiss" \
